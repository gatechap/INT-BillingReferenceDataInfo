...
public class QueryAllSplitRuleListCESRowMapper implements RowMapper<QueryAllSplitRuleListInfoDAO> {
    @Override
    public QueryAllSplitRuleListInfoDAO mapRow(ResultSet rs, int rowNum) throws SQLException {
        QueryAllSplitRuleListInfoDAO modelInfo = new QueryAllSplitRuleListInfoDAO();
